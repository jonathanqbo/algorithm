...
public class Q1053PreviousPermutationWithOneSwap {
    ...
    /**
     ...
     solution: Simulate the Math process

     find the first increase item from right to left
     then find the greatest item that < that item
     swap them
